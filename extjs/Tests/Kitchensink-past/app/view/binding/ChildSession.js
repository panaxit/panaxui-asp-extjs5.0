...
Ext.define('KitchenSink.model.Address', {
    extend: 'KitchenSink.model.Base',

    fields: [
        { name: 'customerId', type: 'string', reference: 'Customer' },//{ type: 'int' },
        { name: 'address', type: 'string' },//{ type: 'int' },
    ]
});
...
Ext.define('KitchenSink.store.Address', {
    extend: 'Ext.data.Store',

    alias: 'store.address',

    model: 'KitchenSink.model.Address'
	// data: [
		// { name: 'USA' },
		// { name: 'Canada' }
	// ]
...
Ext.define('KitchenSink.model.Customer', {
	...
	, associations: [
		{ type: 'hasMany', model: "KitchenSink.model.Address", name: "address",  tableName: 'PcD.ServiciosDomicilio' ,primaryKey: "IdPcD,IdServicio", identityKey: 'Id', foreignKey: "customerId", associationKey: "address"}
		, { type: 'hasMany', model: "KitchenSink.model.Order", name: "orders",  tableName: 'PcD.ServiciosDomicilio' ,primaryKey: "IdPcD,IdServicio", identityKey: 'Id', foreignKey: "customerId", associationKey: "orders"}
	]
...
Ext.define('KitchenSink.view.binding.ChildSessionController', {
	...
	onSave: function () {
       ...
       var session = this.getView().getSession(); //this.getView().getSession().getSchema().getEntity("KitchenSink.model.Customer").getProxy().update()
