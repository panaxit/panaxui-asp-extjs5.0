        ...
        return [
            {
                ...
                expanded: true,
                children: [
                    { id: "basic-panels", text: "Basic Panel", className: "KitchenSink.view.panel.BasicPanels", leaf: true },
                    { id: "framed-panels", text: "Framed Panel", className: "KitchenSink.view.panel.FramedPanels", leaf: true }
                ]
            },
            {
                text: "Grids",
                expanded: true,
                children: [
                    { id: "array-grid", text: "Array Grid", className: "KitchenSink.view.grid.ArrayGrid", leaf: true },
            ...
            },
            {
                ...
                children: [{
                    ...
                    children: [
                        ...
                        { id: 'binding-two-way', className: 'KitchenSink.view.binding.TwoWay', text: 'Two Way', leaf: true },
                        { id: 'binding-formulas', className: 'KitchenSink.view.binding.Formulas', text: 'Formulas', leaf: true },
                        { id: 'binding-associations', className: 'KitchenSink.view.binding.Associations', text: 'Associations', leaf: true },
                        { id: 'binding-component-state', text: 'Component State', leaf: true },
                        { id: 'binding-chained-stores', className: 'KitchenSink.view.binding.ChainedStores', text: 'Chaining Stores', leaf: true}
                    ]
                }, {
                    text: 'Advanced',
                    expanded: true,
                    children: [
                        { id: 'binding-combo-chaining', className:'KitchenSink.view.binding.ComboChaining', text: 'Chained ComboBoxes', leaf: true },
//                        { id: 'binding-gridform', text: 'Grid + Form', leaf: true },
                        { id: 'binding-model-validation', text: 'Model Validation', leaf: true },
                        { id: 'binding-field-validation', className:'KitchenSink.view.binding.FieldValidation', text: 'Field Validation', leaf: true },
                        { id: 'binding-two-way-formulas', className: 'KitchenSink.view.binding.TwoWayFormulas', text: 'Two-Way Formulas', leaf: true }
						,{ id: 'custom-form', className: 'KitchenSink.view.binding.CustomForm', text: 'Custom Form example', leaf: true }
						,{ id: 'binding-child-session', className: 'KitchenSink.view.binding.ChildSession', text: 'Issolated Child Session', leaf: true }
                    ]
                }]
            },
            {
