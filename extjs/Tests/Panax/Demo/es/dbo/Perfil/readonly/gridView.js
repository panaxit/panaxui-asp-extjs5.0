...
Ext.define('Px.Demo.es.dbo.Perfil.readonly.gridView', { 
...
Ext.define("Demo.es.dbo.Perfil.readonly.gridView", {
...
, useNull: true
    ...
    var ajaxStore = Ext.create('Panax.custom.AjaxStore', {
        ...
        , defaultPageSize: 0
        , remoteSort: true
        , model: "Demo.es.dbo.Perfil.readonly.gridView"
...
, filter: {updateBuffer: 1500, type: 'list', dataIndex: "PerfilDelQueDepende", store: Ext.create('Ext.data.Store', {
        fields: ['id', 'text']
        , proxy: {
            type: 'ajax'
            , url: '../Scripts/xmlCatalogOptions.asp'
