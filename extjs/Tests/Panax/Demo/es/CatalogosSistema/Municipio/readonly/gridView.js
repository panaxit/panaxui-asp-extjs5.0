...
Ext.define('Px.Demo.es.CatalogosSistema.Municipio.readonly.gridView', { 
...
Ext.define("Demo.es.CatalogosSistema.Municipio.readonly.gridView", {
    extend: 'Ext.data.Model'
    
    , primaryKeys: 'Id'
    , fields: [{name:'Id',fieldName:'Id',  mapping:'Id["value"]', isAlwaysSubmitable: true
, useNull: true
}, {name:'fk',fieldName:'fk',  mapping:'fk["value"]'
, useNull: true
}, {name:'Municipio',fieldName:'Municipio',  mapping:'Municipio["value"]'
, useNull: true
}]
	, validations: []
    ...
    var ajaxStore = Ext.create('Panax.custom.AjaxStore', {
        ...
        , defaultPageSize: 0
        , remoteSort: true
        , model: "Demo.es.CatalogosSistema.Municipio.readonly.gridView"
		
        , settings: {
			catalogName: "CatalogosSistema.Municipio"
			//, filters: !me.identity?"0=0":"[]="+me.identity
			, identityKey: ""
			, primaryKey: "Id"
			, mode: "readonly"
...
, editor: new Ext.form.field.ComboBox({
	...
	, store: Ext.create('Ext.data.Store', {
        ...
        , proxy: {
			...
			, sortParam: 'sorters'
			, extraParams: {
				catalogName: "CatalogosSistema.Estado"
				, filters: ""
				, dataValue: "RTRIM([Id])"
				, dataText: "RTRIM([Estado])"
...
, filter: {updateBuffer: 1500, type: 'list', dataIndex: "fk", store: Ext.create('Ext.data.Store', {
        fields: ['id', 'text']
        , proxy: {
            type: 'ajax'
            , url: '../Scripts/xmlCatalogOptions.asp'
