        ...
        return [
            ...
            },
            {
                ...
                children: [
                    ...
                    { id: 'binding-two-way', text: 'Two Way', leaf: true, className: 'KitchenSink.view.binding.TwoWay'},							
                    { id: 'binding-formulas', text: 'Formulas', leaf: true, className: 'KitchenSink.view.binding.Formulas'},                       
                    { id: 'binding-associations', text: 'Associations', leaf: true, className: 'KitchenSink.view.binding.Associations'},               
                    { id: 'binding-component-state', text: 'Component State', leaf: true },         
                    { id: 'binding-chained-stores', text: 'Chaining Stores', leaf: true, className: 'KitchenSink.view.binding.ChainedStores'},           
                    { id: 'binding-combo-chaining', text: 'Chained ComboBoxes', leaf: true, className:'KitchenSink.view.binding.ComboChaining'},
...
//                    { id: 'binding-gridform', text: 'Grid + Form', leaf: true },        
                    ...
                    { id: 'binding-field-validation', text: 'Field Validation', leaf: true , className:'KitchenSink.view.binding.FieldValidation'},
                    { id: 'binding-two-way-formulas', text: 'Two-Way Formulas', leaf: true , className: 'KitchenSink.view.binding.TwoWayFormulas'},
                    { id: 'binding-slider-form', text: 'Slider and Form Fields', leaf: true},
                    { id: 'custom-form', text: 'Custom Form', leaf: true, className: 'KitchenSink.view.binding.CustomForm'},
                    { id: 'binding-child-session', text: 'Isolated Child Sessions', leaf: true, className: 'KitchenSink.view.binding.ChildSession'}
                ]
            },
            {
                text: 'Trees',
