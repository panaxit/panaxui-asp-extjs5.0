Ext.define('Px.data.CountryState', {
    requires: [
        'Px.data.Init'
    ]
}, function() {
...
Ext.define('Px.model.tree.Country', {
...
Ext.define('Px.store.Countries', {
    extend: 'Ext.data.Store',

    alias: 'store.table.field.countries',

    model: 'Px.model.tree.Country'
	// data: [
		// { name: 'USA' },
		// { name: 'Canada' }
	// ]
...
Ext.define('Px.view.security.CustomFormModel', {
    extend: 'Ext.app.ViewModel',

    alias: 'viewmodel.security-two-way-formulas',
...
Ext.define('Px.view.security.CustomForm', {
    extend: 'Ext.form.Panel',
    xtype: 'custom-form',
	// requires: ['Ext.ux.GroupTabPanel'],
    //<example>
    exampleDescription: [
        '<p>This example shows data security using formulas that can be edited. That is, ',
    ...
    // otherContent: [{
        // type: 'ViewModel',
        // path: 'app/view/security/CustomFormModel.js'
    // }],
    bodyPadding: 10,
    //</example>
    ...
    viewModel: {
        ...
        type: 'security-two-way-formulas',
		...
		,items: [
			{
				...
				items: [{
					...
					// items: [
					// ]
					html: Px.DummyText.extraLongText
				}, {
					title: 'Groups'
					, glyph: 85
					, layout: 'column'
